...
DYLD_LIBRARY_PATH=/usr/local/cuda/lib:/usr/local/gcc-4.7.2/lib:$DYLD_LIBRARY_PATH

export CLASSPATH=$CLASSPATH:~/.bin/jars/antlr-3.4-complete.jar
export PATH=~/.bin:/usr/local/bin:/usr/local/sbin:/Developer/NVIDIA/CUDA-5.0/bin:$PATH
